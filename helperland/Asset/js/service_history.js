...
$(document).ready(function() {
    $('#firstname').on('input', function() {
        ...
        if (firstName.length == 0) {
            ...
            $('.first-name-msg').addClass('invalid-msg').text('Only characters allowed');
            $(this).addClass('invalid-input').removeClass('valid-input');
    ...
    $('#lastname').on('input', function() {
        ...
        if (lastName.length == 0) {
            ...
            $('.last-name-msg').addClass('invalid-msg').text('Only characters allowed');
            $(this).addClass('invalid-input').removeClass('valid-input');
    ...
    $('.birthdate').on("click", function() {
        if (($('#dateofbirth').val() == "Day" || $('#dateofmonth').val() == "Month" || $(
                '#yearofbirth').val() == "Year")) {
            $('.date-error').addClass('invalid-msg').text("Enter Valid Date of Birth");
    ...
    $('#mysetting').on('input', function(e) {
        e.preventDefault();
        if ($('#mysetting').find('.invalid-input').length > 0) {
            $('#save_details').prop('disabled', true);
        } else {
            $('#save_details').prop('disabled', false);
        }
...
$(document).ready(function() {
    ...
    $('#oldpassword').on('input', function() {
        ...
        if (oldpassword.length == 0) {
            $('.old-password-msg').addClass('invalid-msg').text('Old Password is required');
            $(this).addClass('invalid-input').removeClass('valid-input');
        } else {
    ...
    $('#password_change').on('input', function(e) {
        e.preventDefault();
        if ($('#password_change').find('.invalid-input').length > 0) {
            //alert('invalid');
